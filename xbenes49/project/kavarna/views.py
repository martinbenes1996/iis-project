...
def search(request):
    ...
    if d['key'] == '':
        ...
        d['caferesults'] = models.Cafe.objects.filter(Q(name__icontains=d['key']) | Q(street__icontains=d['key']) | Q(city__icontains=d['key'])).distinct()
    # ...
    ...
    if d['key'] == '':
        ...
        d['coffeeresults'] = models.Coffee.objects.filter(Q(name__icontains=d['key']) | Q(place_of_origin__icontains=d['key']) | Q(quality__icontains=d['key']) | Q(taste_description__icontains=d['key'])).distinct()
    #...
    ...
    if d['key'] == '':
        ...
        d['eventresults'] = models.Event.objects.filter(Q(name__icontains=d['key'])).distinct()
    # ...
