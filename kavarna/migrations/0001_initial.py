    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drinker', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='kavarna.Drinker')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('participants', models.ManyToManyField(to='kavarna.Drinker')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kavarna.Drinker')),
                ('cafe', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kavarna.Cafe')),
                ('comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kavarna.Reaction')),
                ('evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kavarna.Evaluation')),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kavarna.Event')),
            ],
        ),
        migrations.AddField(
            model_name='coffee',
